...
Revision ID: 2c90587716d7
Revises: 
Create Date: 2017-02-26 15:22:27.351105
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['recommendation_id'], ['movie.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('default_list_item',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('movie_id', sa.Integer(), nullable=True),
    sa.Column('list_id', sa.Integer(), nullable=True),
    sa.Column('notes', sa.String(length=64), nullable=True),
    ...
    sa.ForeignKeyConstraint(['list_id'], ['default_list.id'], ),
    sa.ForeignKeyConstraint(['movie_id'], ['movie.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('fav_list_item',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('movie_id', sa.Integer(), nullable=True),
    sa.Column('list_id', sa.Integer(), nullable=True),
    sa.Column('notes', sa.String(length=64), nullable=True),
    sa.Column('ordering', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['list_id'], ['fav_list.id'], ),
    sa.ForeignKeyConstraint(['movie_id'], ['movie.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('fav_list_item')
    op.drop_table('default_list_item')
